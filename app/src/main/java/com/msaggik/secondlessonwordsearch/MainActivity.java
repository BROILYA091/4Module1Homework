...
public class MainActivity extends AppCompatActivity {
    ...
    private View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            String resultSearch = searchMapPoem(Integer.parseInt(searchText), mapPoem); // поиск строки по длине в мап

            if (resultSearch == null) { // если в поэме ничего не найдено, то
                output.setText("Данных строк по заданной длине в поэме не найдено");
            } else {
                output.setText("Найдено " + resultSearch);
            }
        }
    };

    // Изменения в методе searchMapPoem:
    private String searchMapPoem(int length, Map<Integer, String> map) {
        ...
        for (Integer key : map.keySet()) { // перебор мап по ключам
            if (map.get(key).length() == length) { // если длина строки равна искомой длине, то
                count++; // счётчик найденных строк
                result.append("\n\n").append(map.get(key)); // формирование строки найденных строк
            }
        }
        ...
        if (count == 0) {
            ...
            return count + " строк данной длины найдены:" + result.toString(); // вывод количества найденных строк и самих строк
        }
    }
